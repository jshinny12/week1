...
snarkjs plonk setup _plonk_Multiplier3/Multiplier3.r1cs powersOfTau28_hez_final_22.ptau _plonk_Multiplier3/circuit_final.zkey
...
snarkjs zkey export verificationkey _plonk_Multiplier3/circuit_final.zkey _plonk_Multiplier3/_plonk_verification_key.json
